export const fhirForm = {
  ...
  item: [
    ...
    },
    {
      linkId: 'group-basic',
      type: 'group',
      text: 'A group of basic questions',
      item: [
        {
          linkId: 'radio-choice',
          type: 'choice',
      ...
      item: [
        {
          ...
          repeats: true,
          answerValueSet:
            'https://clinicaltables.nlm.nih.gov/fhir/R4/ValueSet/icd10cm',
          extension: [
            {
          ...
          item: [
            {
              ...
              type: 'choice',
              answerValueSet:
                'https://clinicaltables.nlm.nih.gov/fhir/R4/ValueSet/rxterms',
              extension: [
                {
                  url: 'http://hl7.org/fhir/StructureDefinition/questionnaire-itemControl',
                  valueCodeableConcept: {
